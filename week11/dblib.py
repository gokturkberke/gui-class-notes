...
class ToDoDatabase:
    ...
    def create_table(self):
        conn = sqlite3.connect(self.db_name) #veritabanina bagladik
        cur = conn.cursor() #sql komutlarini calistirmak icin cursor olusturduk
        cur.execute("""
        ...
        """)
        conn.commit() #veritabanina yaptigimiz degisiklikleri kaydettik
        conn.close()
    ...
    def get_items(self):
        ...
        items = cur.fetchall() #fetchall ile veritabanindaki tum verileri aliyoruz
        conn.close()
