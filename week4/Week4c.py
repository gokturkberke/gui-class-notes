...
file_menu.add_command(label="Open...", underline=0) #open... komutunu file menusune ekler 
file_menu.add_separator() #menu ogeleri arasina bir yatay cizgi yerlestirir
file_menu.add_command(label="Exit", command=win.destroy, underline=1) #exit ekler x harfini alti cizili yapar ve kullanici buna tikaldiginda pencerenin kapanmasini saglar
